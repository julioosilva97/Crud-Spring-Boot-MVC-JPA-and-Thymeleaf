...
public class FuncionarioController {
	...
	public String salvar(@Valid Funcionario funcionario, BindingResult result, RedirectAttributes attr){
		...
		attr.addFlashAttribute("sucess","Funcioário cadastrado com sucesso");
